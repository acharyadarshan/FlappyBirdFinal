...
const createPipe = () => {
    for (let count = 0; count < PIPE_COUNT; count++) {
        const pipe_height = getRandomInt(150, MAXIMUM_PIPE_HEIGHT * 0.92);

        drawPipe(pipe_height, "top");
        drawPipe(MAXIMUM_PIPE_HEIGHT - pipe_height, "bottom");
...
const drawPipe = (height, position) => {
